...
app.didRangeBeaconsInRegion = function(pluginResult)
{
	...
	if ((beacon.proximity == 'ProximityImmediate' || beacon.proximity == 'ProximityNear'||beacon.proximity == 'ProximityFar')
		&& app.currentPage == 'Pg-default' || app.currentPage == 'Pg-Admissions' || app.currentPage == 'Pg-Welcome' || app.currentPage == 'Pg-Bursar')
	{
		app.gotoPage(pageId)
		return
	}
